import requests
from axe_core import AxeResults
from axe_core.commons.checks import CheckSettings
from axe_core.commons.htmlcs import HTMLCodeSnippet
from axe_core.selenium_python import driver_factory
